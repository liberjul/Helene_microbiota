...
path1 <- "/work/jal138/Helene_sampling/demultiplexed_ITS/noprimers/filtered/" # CHANGE ME to location of the First Replicate fastq files
...
saveRDS(err1, file.path(path.rds, "ITS_err1.rds"))

pdf(file.path(path.out, "ITS_seq_errors_plot.pdf"))
plotErrors(err1)
dev.off()
